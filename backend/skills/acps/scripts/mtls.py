"""mTLS client SSL context for Skill scripts (AipRpcClient). ``None`` ⇒ plain HTTP."""
...
def get_client_ssl_context(
    ...
    """Build client ``ssl.SSLContext`` for mTLS; *service_root* is Backend root. Returns ``None`` to fall back to HTTP."""
